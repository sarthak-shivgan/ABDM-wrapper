...
public class Frequency {
  ...
  **/
  ...
  public Frequency value(Integer value) {
  ...
  **/
  ...
  public Frequency repeats(Integer repeats) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.unit, frequency.unit) &&
        Objects.equals(this.value, frequency.value) &&
        Objects.equals(this.repeats, frequency.repeats);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Frequency
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Frequency.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Frequency.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Frequency` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
