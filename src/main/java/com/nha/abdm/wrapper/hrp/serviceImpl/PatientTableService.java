...
public class PatientTableService {
  ...
  public void updateCareContextStatus(
      String patientReference, List<CareContextBuilder> careContexts) {
    BulkOperations bulkOperations =
        mongoTemplate.bulkOps(BulkOperations.BulkMode.UNORDERED, Patients.class);
  ...
  public boolean checkCareContexts(InitResponse data) {
    try {
      List<CareContextBuilder> patientCareContexts =
          patientRepo
